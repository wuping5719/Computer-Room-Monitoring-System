...
public interface HCNetSDK extends StdCallLibrary {
    ...
    //此处加载路径已经修改
    public static final String path = "D:\\Java\\HCNetSDK\\lib\\HCNetSDK";
	...
	public int dwAlarmType;/*
			        * 0-信号量报警,1-硬盘满,2-信号丢失,3－移动侦测,4－硬盘未格式化,5-读写硬盘出错,6
			        * -遮挡报警,7-制式不匹配, 8-非法访问, 0xa-GPS定位信息(车载定制)
			        */
	...
	public short wScreenSaveTime; /*
				       * 屏幕保护时间
				       * 0-从不,1-1分钟,2-2分钟,3-5分钟,4-10分钟,5-20
				       * 分钟,6-30分钟
				       */
...
interface PlayCtrl extends StdCallLibrary {
    ...
    public static final String path = "D:\\Java\\HCNetSDK\\lib\\PlayCtrl";
    
    PlayCtrl INSTANCE = (PlayCtrl) Native.loadLibrary(path, PlayCtrl.class);
