...
{
    private static final long serialVersionUID = 7086549704266372504L;
    ...
    private void initComponents() {
        ...
        jLabel5 = new JLabel();
        jLabel6 = new JLabel();
        jComboBoxCompressType = new JComboBox<Object>();
        jComboBoxImageQulity = new JComboBox<Object>();
        jComboBoxFrameRate = new JComboBox<Object>();
        jComboBoxStreamType = new JComboBox<Object>();
        jComboBoxMaxBitRate = new JComboBox<Object>();
        jLabel17 = new JLabel();
        jLabel8 = new JLabel();
        jComboBoxResolution = new JComboBox<Object>();
        jLabel7 = new JLabel();
        jLabel9 = new JLabel();
        jComboBoxBitRateType = new JComboBox<Object>();
        jComboBoxBpInterval = new JComboBox<Object>();
        ...
        jLabel11 = new JLabel();
        jLabel12 = new JLabel();
        jComboBoxPreRecordTime = new JComboBox<Object>();
        jComboBoxRecordDelay = new JComboBox<Object>();
        jLabel13 = new JLabel();
        jLabel14 = new JLabel();
        ...
        jLabel19 = new JLabel();
        jLabel20 = new JLabel();
        jComboBoxOSDFormat = new JComboBox<Object>();
        jComboBoxDateFormat = new JComboBox<Object>();
        jComboBoxTimeFormat = new JComboBox<Object>();
        ...
        jComboBoxCompressType.setModel(new DefaultComboBoxModel<Object>(new String[] { "录像(主码流)", "网传(子码流)", "事件触发" }));
        ...
        jComboBoxImageQulity.setModel(new DefaultComboBoxModel<Object>(new String[] { "最好", "次好", "较好", "一般", "较差", "差" }));

        jComboBoxFrameRate.setModel(new DefaultComboBoxModel<Object>(new String[] { "全部", "1/16", "1/8", "1/4", "1/2", "1", "2", "4", "6", "8", "10", "12", "16", "20", "15", "18", "22" }));

        jComboBoxStreamType.setModel(new DefaultComboBoxModel<Object>(new String[] { "视频流", "复合流" }));

        jComboBoxMaxBitRate.setModel(new DefaultComboBoxModel<Object>(new String[] { "32K", "48K", "64K", "80K", "96K", "128K", "160K", "192K", "224k", "256K", "320K", "384K", "448K", "512K", "640K", "768K", "896K", "1024K", "1280K", "1536K", "1792K", "2048K", "自定义" }));

        jLabel17.setText("分辨率");

        jLabel8.setText("I帧间隔");

        jComboBoxResolution.setModel(new DefaultComboBoxModel<Object>(new String[] { "DCIF", "CIF", "QCIF", "4CIF", "2CIF", "VGA", "UXGA", "SVGA", "HD720p", "SXGA" }));

        jLabel7.setText("位率类型");

        jLabel9.setText("BP帧间隔");

        jComboBoxBitRateType.setModel(new DefaultComboBoxModel<Object>(new String[] { "定码率", "变码率" }));

        jComboBoxBpInterval.setModel(new DefaultComboBoxModel<Object>(new String[] { "BBP帧", "BP帧", "单P帧" }));
        ...
        jComboBoxPreRecordTime.setModel(new DefaultComboBoxModel<Object>(new String[] { "不预录", "5秒", "10秒", "15秒", "20秒", "25秒", "30秒", "不受限制" }));

        jComboBoxRecordDelay.setModel(new DefaultComboBoxModel<Object>(new String[] { "5秒", "10秒", "30秒", "1分", "2分", "5分", "10分" }));
        ...
        jComboBoxOSDFormat.setModel(new DefaultComboBoxModel<Object>(new String[] { "透明 不闪烁", "不透明 闪烁", "不透明 不闪烁" }));

        jComboBoxDateFormat.setModel(new DefaultComboBoxModel<Object>(new String[] { "XXXX-XX-XX (年月日)", "XX-XX-XXXX (月日年)", "XXXX年XX月XX日", "XX月XX日XXXX年", "XX-XX-XXXX 日月年", "XX日XX月XXXX年" }));

        jComboBoxTimeFormat.setModel(new DefaultComboBoxModel<Object>(new String[] { "24小时制", "12小时制" }));
    ...
    public JComboBox<Object> jComboBoxBitRateType;
    public JComboBox<Object> jComboBoxBpInterval;
    public JComboBox<Object> jComboBoxChannelNumber;
    public JComboBox<Object> jComboBoxCompressType;
    public JComboBox<Object> jComboBoxDateFormat;
    public JComboBox<Object> jComboBoxFrameRate;
    public JComboBox<Object> jComboBoxImageQulity;
    public JComboBox<Object> jComboBoxMaxBitRate;
    public JComboBox<Object> jComboBoxOSDFormat;
    public JComboBox<Object> jComboBoxPreRecordTime;
    public JComboBox<Object> jComboBoxRecordDelay;
    public JComboBox<Object> jComboBoxResolution;
    public JComboBox<Object> jComboBoxStreamType;
    public JComboBox<Object> jComboBoxTimeFormat;
